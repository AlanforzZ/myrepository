        ...
        <div class="span12">
            <div class="widget-box">
                <div class="widget-title"><span class="icon"> <i class="icon-info-sign"></i> </span>
                    <h4 style="color: darkgrey;">修改学生</h4>
                </div>
                <div class="widget-content nopadding">
                    <form class="form-horizontal" method="post" action="${pageContext.request.contextPath}/edit" name="editstu" id="editstu">
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input type="date" name="date" id="date" value="${student.birthday1}">
                            </div>
                        </div>
                        <div class="control-group">
                            <label class="control-label">平均分数</label>
                            <div class="controls">
                                <input type="text" name="score" id="score" value="${student.score}">
                            </div>
                        </div>
                        <div class="control-group">
                            <label class="control-label">备注</label>
                            <div class="controls">
                                <textarea id="mark" name="mark">${student.mark}</textarea>
                            </div>
                        </div>
                        <div class="form-actions">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            ...
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <input type="submit" value="确认修改" class="btn btn-success" align="left">
                        </div>
                    </form>
                </div>
            </div>
